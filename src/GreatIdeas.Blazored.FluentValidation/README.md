# FluentValidation
A library for using FluentValidation with Blazor. This is a fork of the [blazored.fluentvalidation](https://github.com/Blazored/FluentValidation) where packages are updated to be current with the [FluentValidation](https://github.com/FluentValidation) packages.
